...
Will use the passed rootnode &lt;myroot&gt; instead of the normally autogenerated &lt;entries&gt; to produce the following XML:
...
RestKit uses the RestKitExceptionRenderer to respond with REST errors containing rich
error information and corresponding HTTP Status Codes.
